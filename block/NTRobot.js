...
goog.provide('Blockly.Blocks.NTRobot');

goog.require('Blockly.Blocks');

//////////////////颜色/////////////////////
Blockly.Blocks.NTRobot.HUE = 120;

/////////////////模拟输出//////////////////////
Blockly.Blocks.ks_a_Write = {
  init: function() {
    this.setColour(Blockly.Blocks.NTRobot.HUE);
...
Blockly.Blocks.ks_SW1 = {
  init: function() {
    ...
    .appendField(new Blockly.FieldImage("../../media/NTRobot/switch.png", 43, 32));
...
Blockly.Blocks.ks_Knob = {
  init: function() {
    ...
    .appendField(new Blockly.FieldImage("../../media/NTRobot/VR.png", 43, 32));
    this.setInputsInline(true);
    this.setOutput(true, Number);
    this.setTooltip('');
  }
...
Blockly.Blocks.ks_analogRead = {
  init: function() {
    ...
    .appendField(new Blockly.FieldImage("../../media/NTRobot/Analog.png", 50, 40));
    this.appendDummyInput()
    .appendField(new Blockly.FieldDropdown([["A0","36"],["A1","39"], ["A2","34"], ["A3","35"], ["A4","32"]]), "PIN");
    this.setInputsInline(true);
    this.setOutput(true, Number);
    this.setTooltip('');
  }
...
Blockly.Blocks.NTRobot_motor_forward = {
  init: function() {
    this.setColour(Blockly.Blocks.NTRobot.HUE);
    this.appendDummyInput("")
...
Blockly.Blocks.NTRobot_motor_backward = {
  init: function() {
    this.setColour(Blockly.Blocks.NTRobot.HUE);
    this.appendDummyInput("")
...
Blockly.Blocks.NTRobot_motor_TurnLeft = {
  init: function() {
    this.setColour(Blockly.Blocks.NTRobot.HUE);
    this.appendDummyInput("")
...
Blockly.Blocks.NTRobot_motor_TurnRight = {
  init: function() {
    this.setColour(Blockly.Blocks.NTRobot.HUE);
    this.appendDummyInput("")
...
Blockly.Blocks.NTRobot_motor_SpinLeft = {
  init: function() {
    this.setColour(Blockly.Blocks.NTRobot.HUE);
    this.appendDummyInput("")
...
Blockly.Blocks.NTRobot_motor_SpinRight = {
  init: function() {
    this.setColour(Blockly.Blocks.NTRobot.HUE);
    this.appendDummyInput("")
...
Blockly.Blocks.NTRobot_motor_stop = {
  init: function() {
    this.setColour(Blockly.Blocks.NTRobot.HUE);
    this.appendDummyInput()
...
Blockly.Blocks.ke_oled = {
  init: function() {
    ...
    .appendField(new Blockly.FieldImage("../../media/NTRobot/OLED.png", 70, 32));
...
Blockly.Blocks.NTRobot_Robot_begin = {
  init: function() {
    this.setColour(Blockly.Blocks.NTRobot.HUE);
    this.appendDummyInput()
...
Blockly.Blocks.NTRobot_wait = {
  init: function() {
    this.setColour(Blockly.Blocks.NTRobot.HUE);
    this.appendDummyInput()
    .appendField("Wait for press OK:")
    this.setInputsInline(true); 
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
  }
